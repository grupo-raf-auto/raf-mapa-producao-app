    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString('pt', { month: 'long' }),
        ...formatters,
      }}
      classNames={{
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'text-foreground hover:bg-muted hover:text-foreground rounded-md transition-colors',
        'data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground',
        'data-[selected-single=true]:hover:bg-primary data-[selected-single=true]:hover:text-primary-foreground data-[selected-single=true]:active:bg-primary data-[selected-single=true]:active:text-primary-foreground data-[selected-single=true]:cursor-default',
        'data-[today=true]:ring-2 data-[today=true]:ring-primary/40 data-[today=true]:ring-inset data-[today=true]:font-medium',
