  ...
  try {
    ...
    if (mimeType === 'application/pdf') {
      try {
        ...
        throw new Error('Processamento de PDF requer pdf-parse. Execute: npm install pdf-parse');
      }
    }
    ...
    if (
      ...
      try {
        ...
        throw new Error('Processamento de DOCX requer mammoth. Execute: npm install mammoth');
      }
    }
