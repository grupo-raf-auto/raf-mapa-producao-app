...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full py-6 hidden md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-[300px] shrink-0 fixed left-0 top-0 z-40 border-r border-neutral-200 dark:border-neutral-700",
        className
      )}
      animate={{
