...
export const GET = wrap(
  handler.GET as (req: NextRequest, ctx: unknown) => Promise<Response>,
);
export const POST = wrap(
  handler.POST as (req: NextRequest, ctx: unknown) => Promise<Response>,
);
