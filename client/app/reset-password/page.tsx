    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Redefinir senha</h1>
          <p className="text-gray-500 mb-6">
            Use o link recebido por email para redefinir a sua senha. O link inclui um token de segurança.
          </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <p className="text-gray-500 mb-6">Defina uma nova senha (mín. 8 caracteres).</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? 'A guardar...' : 'Redefinir senha'} <ArrowRight className="h-4 w-4" />
          </button>
        </form>
