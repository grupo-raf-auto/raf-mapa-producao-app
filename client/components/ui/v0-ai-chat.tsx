...
const defaultQuickActions: QuickAction[] = [
    ...
    },
    {
        ...
        action: "Como funciona o website? Quais são as principais funcionalidades disponíveis?",
    },
];
            ...
            <div className="flex items-center justify-between pb-3 sm:pb-4 mb-3 sm:mb-4 border-b border-border/40 shrink-0 px-1">
                <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h2 className="font-semibold text-sm sm:text-base text-foreground tracking-tight leading-tight truncate">{title}</h2>
                        <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5 hidden sm:block">Assistente inteligente</p>
                    </div>
                </div>
                        ...
                        {defaultQuickActions.map((action, index) => (
                            ...
                            >
                                ...
                                <div className="min-w-0 w-full">
                                    <p className="font-medium text-xs sm:text-sm text-foreground mb-0.5 sm:mb-1">{action.title}</p>
                    ...
                    {loading && (
                        <div className="flex gap-2.5 sm:gap-3.5 animate-in fade-in">
                            ...
                            <div className="bg-muted/60 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 border border-border/50">
                                <Spinner variant="bars" className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-muted-foreground" />
                            </div>
                        </div>
                    )}
