...
const NetworkPattern = () => (
  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Connection lines */}
    <path d="M100 80 L200 120 L300 60" stroke="#C9A861" strokeWidth="1" strokeOpacity="0.3" />
    <path d="M200 120 L250 200 L320 180" stroke="#1E3A5F" strokeWidth="1" strokeOpacity="0.3" />
    <path d="M100 80 L80 180 L150 250" stroke="#C9A861" strokeWidth="1" strokeOpacity="0.2" />
    <path d="M250 200 L200 280 L280 320" stroke="#1E3A5F" strokeWidth="1" strokeOpacity="0.3" />
    <path d="M150 250 L200 280" stroke="#C9A861" strokeWidth="1" strokeOpacity="0.3" />
    ...
    <div className="flex w-full h-full items-center justify-center p-4">
      ...
      >
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center bg-card">
          <h1 className="font-title text-2xl md:text-3xl font-bold mb-1 text-foreground">Bem-vindo de volta</h1>
          <p className="text-muted-foreground mb-2">Inicie sessão na sua conta</p>
          <p className="text-xs text-muted-foreground mb-6">Apenas e-mails @gruporaf.pt são permitidos</p>
          ...
          {activeTab === 'login' ? (
            ...
            <div className="text-center py-8">
              <p className="text-muted-foreground mb-4">Para criar uma conta, contacte o administrador do sistema.</p>
              <Link
                href="/sign-up"
