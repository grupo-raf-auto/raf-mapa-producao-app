...
export function Sidebar() {
  ...
  return (
    <aside
      className="w-20 h-screen fixed top-0 flex items-center justify-center py-8 ml-24 overflow-visible z-40 backdrop-blur-sm"
      style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)', left: 0 }}
    >
      <Dock
